terraform {
  source = "tfr:///cloudposse/iam-s3-user/aws//.?version=1.2.1"
}
...
inputs = {
    name                          = include.env.locals.observability_metrics_s3_user_name
    ...
    s3_resources                  = include.env.locals.observability_metrics_s3_user_resources
    tags                          = include.env.locals.tags 
}

skip = include.env.locals.skip_module.observability_metrics_s3_user
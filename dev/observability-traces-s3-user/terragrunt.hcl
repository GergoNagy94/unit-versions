...
inputs = {
    name                          = include.env.locals.observability_traces_s3_user_name
    ...
    s3_resources                  = include.env.locals.observability_traces_s3_user_resources
    tags                          = include.env.locals.tags 
}

skip = include.env.locals.skip_module.observability_traces_s3_user
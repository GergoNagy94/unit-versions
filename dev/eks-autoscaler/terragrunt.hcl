...
inputs = {
  ...
  namespace                        = include.env.locals.autoscaler_namespace
  helm_chart_version               = include.env.locals.autoscaler_helm_chart_version
}
...
skip = include.env.locals.skip_module.eks_autoscaler
...
inputs = {
  repository                  = include.env.locals.otel_collector_helm_chart_repository
  chart                       = include.env.locals.otel_collector_helm_chart_name
  chart_version               = include.env.locals.otel_collector_helm_chart_version

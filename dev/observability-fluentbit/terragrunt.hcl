...
inputs = {
  repository                  = include.env.locals.fluentbit_helm_chart_repository
  chart                       = include.env.locals.fluentbit_helm_chart_name
  chart_version               = include.env.locals.fluentbit_helm_chart_version
  ...
  kubernetes_namespace        = include.env.locals.fluentbit_namespace
...
skip = include.env.locals.skip_module.observability_fluentbit